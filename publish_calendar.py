...
def build_calendar(
    ...
    counts — режим отчёта (день работы над постами): {день: кол-во}. Единственный
      эмодзи ✍️ — на днях, когда создавались статьи; остальные дни — просто цифры.
        ...
        for day in week:
            if day == 0:
                ...
                if counts:
                    ...
                    if cnt:
                        marker = "✍️"  # единственный эмодзи: день работы над постами
                    else:
                        marker = ""  # остальные дни — просто цифра
                elif status:
