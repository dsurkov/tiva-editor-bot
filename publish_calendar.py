...
def build_calendar(
    ...
    counts — режим отчёта (день работы над постами): {день: кол-во}; дни с постами
      помечены ✍️ (цифра не показывается), дни без постов — ⚪/✖️.
        ...
        for day in week:
            if day == 0:
                ...
                if counts:
                    ...
                    if cnt:
                        marker = "✍️"  # в этот день работали над постами
